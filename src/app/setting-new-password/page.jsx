...
const SettingNewPassword = () => {
  ...
  const toggleConfirmPasswordVisibility = () => {
    setShowComfirmPassword(prevShowConfirmPassword => !prevShowConfirmPassword);
  };
  return (
              ...
              <div className='p-4 md:p-12 flex flex-col gap-12'>
                ...
                <div className='flex flex-col gap-6'>
                  ...
                  <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" viewBox="0 0 16 20" fill="none">
                    ...
                    <input type={`${showPassword ? "text" : "password"}`} placeholder="Enter your password" className="border-none w-full py-[0.88rem] outline-none"/>
                  ...
                  <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" viewBox="0 0 16 20" fill="none">
                    ...
                    <input type={`${showConfirmPassword ? "text" : "password"}`} placeholder="Confirm your password" className="border-none w-full py-[0.88rem] outline-none"/>
                ...
                <div className='flex flex-col gap-4'>
                    <Link href="/password-changed">
                        <Button className="w-full bg-[#151515] shadow-md py-3 px-6 flex items-center justify-center gap-2">Save</Button>
                    </Link>
                </div>
                </div>
                </form>

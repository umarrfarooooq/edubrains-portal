...
const MobileExpandableItem = ({ name, icon, subItems, expandedItems, toggleItem, setActiveNav, activeNav, isMiniSidebar }) => {
    return (
      <>
        <li
          onClick={() => {
        ...
        >
          ...
          >
            {icon}
            <span className="ms-3 text-base">{name}</span>
          </Link>
...
export default MobileExpandableItem;
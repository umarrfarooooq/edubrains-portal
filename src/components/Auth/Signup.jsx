        ...
        <div className="flex item-center justify-between p-4 sm:p-8 gap-4">
          ...
          <div className="w-full lg:min-h-[60rem] bg-[#FFFDFA] rounded-3xl border-[#F4F1EB]">
            <div className="p-4 md:p-12 lg:p-20 flex flex-col gap-12">
              <div>
                <Image src={Logo} className="w-40 h-8" alt="logo" />
              </div>
              <div>
                <div>
              ...
              >
                ...
                <div>
                  <Button
                    disabled={loading}
                    className="w-full bg-[#151515] shadow-md"
                  >
                    {loading && (
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex items-center justify-start">
                  <p className="text-sm">
                    Need Help? <span className="font-semibold">Contact Us</span>
                  </p>
                </div>
              </div>
            </div>
